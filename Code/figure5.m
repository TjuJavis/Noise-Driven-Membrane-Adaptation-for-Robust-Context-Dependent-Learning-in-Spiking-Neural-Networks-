...
% 创建图像窗口
figure('Name', 'Figure 5', 'Units', 'Inches', 'Position', [0, 0, 8, 6], 'NumberTitle', 'off');
...
legend('\sigma = 1','\sigma = 1.3','\sigma = 1.6','\sigma = 1.5','\sigma = 2.7','\sigma = 4','Location', 'southeast')
...
print('-depsc', sprintf('%sFigure5.eps', figurePath)); % 保存为EPS格式
hold off;
